...
const { isLoggedIn, isNewRedAuthor, isSectionSelected, isConnectionOpen } = require("../middleware");
...
router.get("/sections/:id/newReds/new", isConnectionOpen, isLoggedIn, isSectionSelected, function (req, res) {
...
router.post("/sections/:id/newRedPanels", isConnectionOpen, isLoggedIn, function (req, res) {
...
router.get("/newRedPanel/:id", isConnectionOpen, function (req, res) {
...
router.get("/sections/:id/newRedPanel/:newRedPanel_id/edit", isConnectionOpen, isLoggedIn, isNewRedAuthor, function (req, res) {
...
router.put("/sections/:id/newRedPanel/:newRedPanel_id", isConnectionOpen, isLoggedIn, isNewRedAuthor, function (req, res) {
...
router.delete("/sections/:id/newRedPanel/:newRedPanel_id", isConnectionOpen, isLoggedIn, isNewRedAuthor, function (req, res) {
