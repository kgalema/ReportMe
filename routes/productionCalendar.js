...
router.get("/productionCalendar", function (req, res) {
...
router.get("/productionCalendar/new", isLoggedIn, isAdmin, function (req, res) {
...
router.post("/productionCalendar", isLoggedIn, isAdmin, function (req, res) {
...
router.get("/productionCalendar/:id", function (req, res) {
...
router.get("/productionCalendar/:id/edit", isLoggedIn, isAdmin, function (req, res) {
    ProductionCalendar.findById(req.params.id, function(err, foundDate){
        if (err || !foundDate) {
...
router.put("/productionCalendar/:id", isLoggedIn, isAdmin, function (req, res) {
...
router.delete("/productionCalendar/:id", isLoggedIn, isAdmin, function (req, res) {
